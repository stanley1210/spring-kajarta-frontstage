...
public class ViewCarAssignedService {
    ...
    // Integer view_car_id = obj.isNull("view_car_id") ? null :
    // obj.getInt("view_car_id");
    // Integer assigned_status = obj.isNull("assigned_status") ? null :
    // obj.getInt("assigned_status");
