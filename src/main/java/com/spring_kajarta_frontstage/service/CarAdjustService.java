...
public class CarAdjustService {
    ...
    // Integer team_leader_id = obj.isNull("team_leader_id") ? null :
    // obj.getInt("team_leader_id");
    // Integer employee_id = obj.isNull("employee_id") ? null :
    // obj.getInt("employee_id");
    // Integer car_id = obj.isNull("car_id") ? null : obj.getInt("car_id");
    // Integer approval_status = obj.isNull("approval_status") ? null :
    // obj.getInt("approval_status");
    // Integer approval_type = obj.isNull("approval_type") ? null :
    // obj.getInt("approval_type");
    // BigDecimal floating_amount = obj.isNull("floating_amount") ? null :
    // obj.getBigDecimal("floating_amount");
    // String create_time = obj.isNull("create_time") ? null :
    // obj.getString("create_time");
    // String update_time = obj.isNull("update_time") ? null :
